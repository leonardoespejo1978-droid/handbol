...
export default function EstadisticaSelector() {
  ...
  const opcions = [
    ...
    },
    {
      ...
      subtitol: "Infantil Masculí · Temporada 25/26",
      color: C.accent3,
      ruta: "/2025/EstadisticaSectorsCE",
    },
    {
      id: "faseFinalCE",
      emoji: "🥇",
      ...
      subtitol: "Infantil Masculí · Temporada 25/26",
      color: C.warning,
      ruta: "/2025/EstadisticaFaseFinalCE",
    },
  ];
  ...
  return (
    <div style={{
      ...
      {/* Botó enrere → torna a la HomePage2025 */}
      <div style={{ position: "absolute", top: "20px", left: "16px" }}>
        <button
          onClick={() => navigate("/historico/2025")}
          style={{
      ...
      <div style={{ textAlign: "center", marginBottom: "40px" }}>
        ...
        <p style={{ color: C.muted, fontSize: "14px", marginTop: "8px" }}>
          Temporada 25/26 · Selecciona la competició que vols consultar
        </p>
      </div>
